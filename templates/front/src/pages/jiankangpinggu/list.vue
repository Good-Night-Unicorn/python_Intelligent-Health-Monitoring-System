	...
	<div>
		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-button class="list-add-btn" v-if="btnAuth('jiankangpinggu','新增')" type="primary" @click="add('/index/jiankangpingguAdd')">
...
<script>
	export default {
		...
		async created() {
			...
			this.selectOptionsList.push({name:'健康评估',list:this.jiankangpingguOptions,tableName: 'jiankangpinggu',check: -1})
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				this.$http.get(`jiankangpinggu/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/jiankangpingguDetail', query: params});
			},
