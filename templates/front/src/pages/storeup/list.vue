<template>
	<div :style='{"width":"100%","padding":"0 calc((100% - 1200px)/2)","fontSize":"16px","color":"#333","background":"#fafcff"}'>
		<div class="back_box">
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 50px 0","margin":"10px auto","color":"#000","textAlign":"center","background":"url(http://codegen.caihongy.cn/20241205/b08c6150728242b18bc30581dde4b827.png) no-repeat bottom center /   100%","width":"101%","lineHeight":"54px","fontSize":"30px","fontWeight":"700"}'>我的收藏</div>
		...
		<el-pagination
			...
			:total="total"
			:style='{"padding":"0","margin":"10px auto","whiteSpace":"nowrap","color":"#333","width":"1200px","fontWeight":"500","order":"50"}'
