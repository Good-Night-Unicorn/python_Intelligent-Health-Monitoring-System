	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="血压" prop="xueya">
				<el-input-number v-model="ruleForm.xueya" placeholder="血压" :disabled=" false ||ro.xueya"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="血糖" prop="xuetang">
				<el-input-number v-model="ruleForm.xuetang" placeholder="血糖" :disabled=" false ||ro.xuetang"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="心率" prop="xinlv">
				<el-input-number v-model="ruleForm.xinlv" placeholder="心率" :disabled=" false ||ro.xinlv"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="体温" prop="tiwen">
				<el-input-number v-model="ruleForm.tiwen" placeholder="体温" :disabled=" false ||ro.tiwen"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="呼吸频率" prop="huxipinlv">
				<el-input v-model="ruleForm.huxipinlv" 
					placeholder="呼吸频率" clearable :disabled=" false  ||ro.huxipinlv"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="运动步数" prop="yundongbushu">
				<el-input v-model="ruleForm.yundongbushu" 
					placeholder="运动步数" clearable :disabled=" false  ||ro.yundongbushu"></el-input>
			</el-form-item>
			...
			<el-form-item class="add-item" label="健康情况" prop="jiankangqingkuang">
				<editor 
