<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'"  label="饮食建议" prop="yinshijianyi" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.yinshijianyi" 
					class="editor"
					myQuillEditor="yinshijianyi"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.yinshijianyi" label="饮食建议" prop="yinshijianyi" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.yinshijianyi"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yinshijianyi = this.ruleForm.yinshijianyi.replace(reg,'../../../djangov5gemqq6/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
