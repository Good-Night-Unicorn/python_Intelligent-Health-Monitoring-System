		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="血压" prop="xueya" >
					<el-input-number v-model="ruleForm.xueya" placeholder="血压" :disabled="ro.xueya"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="血糖" prop="xuetang" >
					<el-input-number v-model="ruleForm.xuetang" placeholder="血糖" :disabled="ro.xuetang"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="心率" prop="xinlv" >
					<el-input-number v-model="ruleForm.xinlv" placeholder="心率" :disabled="ro.xinlv"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="体温" prop="tiwen" >
					<el-input-number v-model="ruleForm.tiwen" placeholder="体温" :disabled="ro.tiwen"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="体温" prop="tiwen" >
					<el-input v-model="ruleForm.tiwen" placeholder="体温" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="呼吸频率" prop="huxipinlv" >
					<el-input v-model="ruleForm.huxipinlv" placeholder="呼吸频率" clearable  :readonly="ro.huxipinlv"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="呼吸频率" prop="huxipinlv" >
					<el-input v-model="ruleForm.huxipinlv" placeholder="呼吸频率" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="运动步数" prop="yundongbushu" >
					<el-input v-model="ruleForm.yundongbushu" placeholder="运动步数" clearable  :readonly="ro.yundongbushu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="运动步数" prop="yundongbushu" >
					<el-input v-model="ruleForm.yundongbushu" placeholder="运动步数" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="健康情况" prop="jiankangqingkuang" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.jiankangqingkuang" 
					class="editor"
					myQuillEditor="jiankangqingkuang"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.jiankangqingkuang" label="健康情况" prop="jiankangqingkuang" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.jiankangqingkuang"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='huxipinlv'){
							this.ruleForm.huxipinlv = obj[o];
							this.ro.huxipinlv = true;
							continue;
						}
						if(o=='yundongbushu'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.jiankangqingkuang = this.ruleForm.jiankangqingkuang.replace(reg,'../../../djangov5gemqq6/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
