<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'"  label="运动计划" prop="yundongjihua" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.yundongjihua" label="运动计划" prop="yundongjihua" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.yundongjihua"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yundongjihua = this.ruleForm.yundongjihua.replace(reg,'../../../djangov5gemqq6/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
