		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"0 30px","margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"#fff","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}' class="select" label="健康评估" prop="jiankangpinggu">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","textAlign":"right","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">健康评估</label>
						<el-select clearable v-model="searchForm.jiankangpinggu" placeholder="请选择健康评估" >
							<el-option v-for="(item,index) in jiankangpingguOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
