	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="血氧饱和度(%)" prop="xueyangbaohedu" >
					<el-input v-model="ruleForm.xueyangbaohedu" placeholder="血氧饱和度(%)" clearable  :readonly="ro.xueyangbaohedu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="血氧饱和度(%)" prop="xueyangbaohedu" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="运动步数(步)" prop="yundongbushu" >
					<el-input v-model="ruleForm.yundongbushu" placeholder="运动步数(步)" clearable  :readonly="ro.yundongbushu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="运动步数(步)" prop="yundongbushu" >
					<el-input v-model="ruleForm.yundongbushu" placeholder="运动步数(步)" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="睡眠质量评分" prop="shuimianzhiliangpingfen" >
					<el-input v-model="ruleForm.shuimianzhiliangpingfen" placeholder="睡眠质量评分" clearable  :readonly="ro.shuimianzhiliangpingfen"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="睡眠质量评分" prop="shuimianzhiliangpingfen" >
					<el-input v-model="ruleForm.shuimianzhiliangpingfen" placeholder="睡眠质量评分" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="运动频率(次/周)" prop="yundongpinlv" >
					<el-input v-model="ruleForm.yundongpinlv" placeholder="运动频率(次/周)" clearable  :readonly="ro.yundongpinlv"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="运动频率(次/周)" prop="yundongpinlv" >
					<el-input v-model="ruleForm.yundongpinlv" placeholder="运动频率(次/周)" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="饮酒习惯" prop="yinjiuxiguan" >
					<el-input v-model="ruleForm.yinjiuxiguan" placeholder="饮酒习惯" clearable  :readonly="ro.yinjiuxiguan"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="饮酒习惯" prop="yinjiuxiguan" >
					<el-input v-model="ruleForm.yinjiuxiguan" placeholder="饮酒习惯" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="吸烟习惯" prop="xiyanxiguan" >
					<el-input v-model="ruleForm.xiyanxiguan" placeholder="吸烟习惯" clearable  :readonly="ro.xiyanxiguan"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="吸烟习惯" prop="xiyanxiguan" >
					<el-input v-model="ruleForm.xiyanxiguan" placeholder="吸烟习惯" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="慢性病史" prop="manxingbingshi" >
					<el-input v-model="ruleForm.manxingbingshi" placeholder="慢性病史" clearable  :readonly="ro.manxingbingshi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="慢性病史" prop="manxingbingshi" >
					<el-input v-model="ruleForm.manxingbingshi" placeholder="慢性病史" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="家族遗传病史" prop="jiazuyichuanbingshi" >
					<el-input v-model="ruleForm.jiazuyichuanbingshi" placeholder="家族遗传病史" clearable  :readonly="ro.jiazuyichuanbingshi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="家族遗传病史" prop="jiazuyichuanbingshi" >
					<el-input v-model="ruleForm.jiazuyichuanbingshi" placeholder="家族遗传病史" readonly></el-input>
				</el-form-item>
		...
		data() {
			return {
				...
				ro:{
					...
					yundongbushu : false,
					sleepduration : false,
					shuimianzhiliangpingfen : false,
					yundongpinlv : false,
					yinjiuxiguan : false,
					xiyanxiguan : false,
					manxingbingshi : false,
					jiazuyichuanbingshi : false,
					healthstatus : false,
				},
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='yundongbushu'){
							this.ruleForm.yundongbushu = obj[o];
							this.ro.yundongbushu = true;
							continue;
						}
						if(o=='sleepduration'){
						...
						if(o=='shuimianzhiliangpingfen'){
							this.ruleForm.shuimianzhiliangpingfen = obj[o];
							this.ro.shuimianzhiliangpingfen = true;
							continue;
						}
						if(o=='yundongpinlv'){
							this.ruleForm.yundongpinlv = obj[o];
							this.ro.yundongpinlv = true;
							continue;
						}
						if(o=='yinjiuxiguan'){
							this.ruleForm.yinjiuxiguan = obj[o];
							this.ro.yinjiuxiguan = true;
							continue;
						}
						if(o=='xiyanxiguan'){
							this.ruleForm.xiyanxiguan = obj[o];
							this.ro.xiyanxiguan = true;
							continue;
						}
						if(o=='manxingbingshi'){
							this.ruleForm.manxingbingshi = obj[o];
							this.ro.manxingbingshi = true;
							continue;
						}
						if(o=='jiazuyichuanbingshi'){
							this.ruleForm.jiazuyichuanbingshi = obj[o];
							this.ro.jiazuyichuanbingshi = true;
							continue;
						}
						if(o=='healthstatus'){
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `healthmonitoring/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.healthmonitoringCrossAddOrUpdateFlag = false;
											this.parent.search();
