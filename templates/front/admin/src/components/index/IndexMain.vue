<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 200px","margin":"0","position":"relative","background":"linear-gradient( 134deg, #F6D7EF 0%, #DEE4F2 100%)","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 0px 00px rgba(0, 0, 0, .3)","padding":"0 40px 0 20px","alignItems":"center","color":"#333","display":"flex","justifyContent":"flex-end","top":"0","left":"40px","background":"none","width":"calc(100% - 40px)","fontSize":"16px","position":"relative","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"0","margin":"0px auto 0 40px","borderColor":"#3b6885","overflow":"hidden","borderRadius":"10px","borderWidth":"0 0 0px 0","background":"rgba(255,255,255,.5)","width":"calc(100% - 40px)","fontSize":"14px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
