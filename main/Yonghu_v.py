...
def yonghu_valueMul(request, xColumnName, timeStatType):
    if request.method in ["POST", "GET"]:
        ...
        for item in req_dict['yColumnNameMul'].split(','):
            sql = ''
            if timeStatType == '日':
                sql = "SELECT DATE_FORMAT({0}, '%Y-%m-%d') {0}, ROUND(sum({1}),2) total FROM yonghu {2} GROUP BY DATE_FORMAT({0}, '%Y-%m-%d')".format(xColumnName, item, where, '%Y-%m-%d')

            if timeStatType == '月':
                sql = "SELECT DATE_FORMAT({0}, '%Y-%m') {0}, ROUND(sum({1}),2) total FROM yonghu {2} GROUP BY DATE_FORMAT({0}, '%Y-%m')".format(xColumnName, item, where, '%Y-%m')

            if timeStatType == '季':
                sql = "SELECT CONCAT(YEAR(MIN({0})), '-Q', QUARTER(MIN({0}))) {0}, sum({1}) total FROM yonghu {2} GROUP BY YEAR({0}), QUARTER({0})".format(xColumnName, item, where)

            if timeStatType == '年':
                sql = "SELECT DATE_FORMAT({0}, '%Y') {0}, ROUND(sum({1}),2) total FROM yonghu {2} GROUP BY DATE_FORMAT({0}, '%Y')".format(xColumnName, item, where, '%Y')
...
def yonghu_o_valueMul(request, xColumnName):
    if request.method in ["POST", "GET"]:
        ...
        where = ' where 1 = 1 '
        for item in req_dict['yColumnNameMul'].split(','):
            sql = "SELECT {0}, ROUND(sum({1}),2) AS total FROM yonghu {2} GROUP BY {0}".format(xColumnName, item, where)
            L = []
            cursor = connection.cursor()
            cursor.execute(sql)
            desc = cursor.description
...
def yonghu_sectionStat_nianling(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        sql = """
            SELECT '十八岁以下' as nianling,case when t.十八岁以下 is null then 0 else t.十八岁以下 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
            ) t
            union all
            SELECT '十八至三十岁' as nianling,case when t.十八至三十岁 is null then 0 else t.十八至三十岁 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
            ...
            union all
            SELECT '三十一至四十岁' as nianling,case when t.三十一至四十岁 is null then 0 else t.三十一至四十岁 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
            ...
            union all
            SELECT '四十一至五十岁' as nianling,case when t.四十一至五十岁 is null then 0 else t.四十一至五十岁 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
            ...
            union all
            SELECT '五十一至六十岁' as nianling,case when t.五十一至六十岁 is null then 0 else t.五十一至六十岁 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
            ...
            union all
            SELECT '六十岁以上' as nianling,case when t.六十岁以上 is null then 0 else t.六十岁以上 end total
            from 
            (select
            sum(case when nianling >= 0 and nianling <= 17 then 1 else 0 end) as 十八岁以下,            sum(case when nianling >= 18 and nianling <= 30 then 1 else 0 end) as 十八至三十岁,            sum(case when nianling >= 31 and nianling <= 40 then 1 else 0 end) as 三十一至四十岁,            sum(case when nianling >= 41 and nianling <= 50 then 1 else 0 end) as 四十一至五十岁,            sum(case when nianling >= 51 and nianling <= 60 then 1 else 0 end) as 五十一至六十岁,            sum(case when nianling >= 61 then 1 else 0 end) as 六十岁以上            from yonghu
            {where}
